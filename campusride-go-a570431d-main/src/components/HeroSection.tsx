...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden" id="home">
      ...
      <div className="absolute top-1/4 left-1/4 w-[min(68vw,500px)] h-[min(68vw,500px)] rounded-full opacity-20 animate-pulse-glow hero-glow-primary" />
      <div className="absolute bottom-1/3 right-1/4 w-[min(60vw,400px)] h-[min(60vw,400px)] rounded-full opacity-15 animate-pulse-glow hero-glow-secondary" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative floating">
              <div className="absolute -inset-4 rounded-3xl opacity-30 card-glow-overlay" />
              <img
                src={heroImg}
