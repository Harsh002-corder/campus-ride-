...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate(response.user.role === "super_admin" ? "/super-admin-dashboard" : ["admin", "sub_admin"].includes(response.user.role) ? "/admin" : response.user.role === "driver" ? "/driver-dashboard" : "/student-dashboard");
    } catch (err) {
