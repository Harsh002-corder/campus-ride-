...
import { buildDailyEarningsFromRides, type DriverDailyEarningsDto } from "@/lib/driverEarnings";
import { ArrowLeft, BadgePercent, CalendarDays, CircleDollarSign, Navigation, ReceiptText, Wallet } from "lucide-react";

const emptyDaily: DriverDailyEarningsDto = {
  summary: {
    totalEarnings: 0,
    platformCharges: 0,
    netDriverEarnings: 0,
...
const DriverDailyEarnings = () => {
  ...
  const [daily, setDaily] = useState<DriverDailyEarningsDto>(emptyDaily);
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Day-wise earnings, platform charges and net payout view.
                  </p>
                </div>
